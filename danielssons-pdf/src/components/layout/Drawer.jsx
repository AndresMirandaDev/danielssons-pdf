...
const Drawer = ({children}) => {
    ...
    return (
        <div className="flex">
            ...
            <div className="fixed top-0 left-0 z-20 w-64 h-full transition-all duration-500 transform -translate-x-full bg-stockholm bg-cover bg-blend-overlay bg-primary shadow-lg peer-checked:translate-x-0">
